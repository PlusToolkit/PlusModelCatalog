...
class ModelCatalogGenerator:
    ...
    def generate_tools_page(self):
        ...
        tracking_fixtures_dir = self.repo_root / 'TrackingFixtures'
        models = []
        ...
        tool_info = {
            ...
            'Stylus_60mm': "Pointer tool with built-in sensor holder. 60mm long, sharp tip.",
        ...
        # Files from TrackingFixtures that should be shown as Tools
        tools_from_fixtures = [
            'Stylus_100mm.stl',
            'Stylus_60mm.stl',
        ...
        # Get specific files from TrackingFixtures
        for stl_file in self.find_stl_files(tracking_fixtures_dir, recursive=True,
                                           include=tools_from_fixtures):
            model_id = stl_file.stem
            description = tool_info.get(model_id, "")
            models.append(self.generate_model_entry(stl_file, description))
